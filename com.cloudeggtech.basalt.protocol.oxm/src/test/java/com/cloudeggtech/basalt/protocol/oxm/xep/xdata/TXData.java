...
import com.cloudeggtech.basalt.protocol.oxm.conversion.converters.TString2XDataType;
import com.cloudeggtech.basalt.protocol.oxm.conversion.validators.TXDataValidationClass;

@ValidationClass(TXDataValidationClass.class)
@ProtocolObject(namespace="jabber:x:data", localName="x")
public class TXData {
	public static final com.cloudeggtech.basalt.protocol.core.Protocol PROTOCOL = new com.cloudeggtech.basalt.protocol.core.Protocol("jabber:x:data", "x");
