package com.cloudeggtech.basalt.protocol.oxm.xml.preprocessing;

import com.cloudeggtech.basalt.protocol.oxm.preprocessing.AbstractProtocolPreprocessor;

public class XmlProtocolPreprocessor extends AbstractProtocolPreprocessor {
	...
	public XmlProtocolPreprocessor() {
		super();
	}
	
	public XmlProtocolPreprocessor(int maxBufferSize) {
		super();
