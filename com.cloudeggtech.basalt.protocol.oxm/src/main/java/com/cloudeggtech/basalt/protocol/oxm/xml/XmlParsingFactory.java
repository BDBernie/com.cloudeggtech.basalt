...
import com.cloudeggtech.basalt.protocol.core.stanza.error.StanzaError.Kind;
...
import com.cloudeggtech.basalt.protocol.oxm.parsers.core.stanza.StanzaParser;
import com.cloudeggtech.basalt.protocol.oxm.parsing.AbstractParsingFactory;
import com.cloudeggtech.basalt.protocol.oxm.parsing.BadMessageException;
...
import com.cloudeggtech.basalt.protocol.oxm.parsing.ParsingContext;
import com.cloudeggtech.basalt.protocol.oxm.parsing.ParsingException;
import com.cloudeggtech.basalt.protocol.oxm.parsing.ParsingUtils;
import com.cloudeggtech.basalt.protocol.oxm.xml.parsers.error.StanzaErrorParser;
	...
	private <T> StanzaError parseElement(XMLStreamReader reader, IParser<T> parser,
		...
		while (true) {
			...
			if (eventType == XMLStreamConstants.CHARACTERS || eventType == XMLStreamConstants.CDATA) {
				...
				throw ParsingUtils.newParsingException(reader, "Unspported XML event type.");
			}
		}
