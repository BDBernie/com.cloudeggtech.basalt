package com.cloudeggtech.basalt.protocol.oxm.parsers.im;
...
public class MessageParserFactory implements IParserFactory<Message> {
	...
	private static final String PATH_MESSAGE_SUBJECT = "/subjects/[subject]";
	private static final String PATH_MESSAGE_BODY = "/bodies/[body]";
